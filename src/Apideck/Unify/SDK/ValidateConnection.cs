...
namespace Apideck.Unify.SDK
{
    ...
    public class ValidateConnection: IValidateConnection
    {
        ...
        public ValidateConnection(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
