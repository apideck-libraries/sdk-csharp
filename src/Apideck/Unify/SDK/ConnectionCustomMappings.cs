...
namespace Apideck.Unify.SDK
{
    ...
    public class ConnectionCustomMappings: IConnectionCustomMappings
    {
        ...
        public ConnectionCustomMappings(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
