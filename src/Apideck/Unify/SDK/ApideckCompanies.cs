...
namespace Apideck.Unify.SDK
{
    ...
    public class ApideckCompanies: IApideckCompanies
    {
        ...
        public ApideckCompanies(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
