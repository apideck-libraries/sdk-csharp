...
namespace Apideck.Unify.SDK
{
    ...
    public class ConnectionSettings: IConnectionSettings
    {
        ...
        public ConnectionSettings(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
