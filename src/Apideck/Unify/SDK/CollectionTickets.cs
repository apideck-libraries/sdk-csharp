...
namespace Apideck.Unify.SDK
{
    ...
    public class CollectionTickets: ICollectionTickets
    {
        ...
        public CollectionTickets(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
