...
namespace Apideck.Unify.SDK
{
    ...
    public class ApiResourceCoverage: IApiResourceCoverage
    {
        ...
        public ApiResourceCoverage(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
