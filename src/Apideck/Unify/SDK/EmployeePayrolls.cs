...
namespace Apideck.Unify.SDK
{
    ...
    public class EmployeePayrolls: IEmployeePayrolls
    {
        ...
        public EmployeePayrolls(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
