...
namespace Apideck.Unify.SDK
{
    ...
    public class EmployeeSchedules: IEmployeeSchedules
    {
        ...
        public EmployeeSchedules(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
