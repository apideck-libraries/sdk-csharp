...
namespace Apideck.Unify.SDK
{
    ...
    public class ConnectorResources: IConnectorResources
    {
        ...
        public ConnectorResources(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
