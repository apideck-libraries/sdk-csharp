...
namespace Apideck.Unify.SDK
{
    ...
    public class ApideckCustomers: IApideckCustomers
    {
        ...
        public ApideckCustomers(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
