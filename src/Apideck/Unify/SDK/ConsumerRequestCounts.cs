...
namespace Apideck.Unify.SDK
{
    ...
    public class ConsumerRequestCounts: IConsumerRequestCounts
    {
        ...
        public ConsumerRequestCounts(ISpeakeasyHttpClient client, Func<Apideck.Unify.SDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
