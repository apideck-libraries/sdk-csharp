...
namespace ApiDeckSdk
{
    ...
    public class Contacts: IContacts
    {
        ...
        public Contacts(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CrmContactsDeleteResponse> DeleteAsync(CrmContactsDeleteRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("crm.contactsDelete", null, _securitySource);
