...
namespace ApiDeckSdk
{
    ...
    public class EmployeeSchedules: IEmployeeSchedules
    {
        ...
        public EmployeeSchedules(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<HrisEmployeeSchedulesAllResponse> ListAsync(HrisEmployeeSchedulesAllRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("hris.employeeSchedulesAll", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetEmployeeSchedulesResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
