...
namespace ApiDeckSdk
{
    ...
    public interface IConnectorDocs
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ConnectorConnectorDocsOneResponse> GetAsync(string id, string docId, string? appId = null, RetryConfig? retryConfig = null);
    }
    ...
    public class ConnectorDocs: IConnectorDocs
    {
        ...
        public ConnectorDocs(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ConnectorConnectorDocsOneResponse> GetAsync(string id, string docId, string? appId = null, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/connector/connectors/{id}/docs/{doc_id}", request);
