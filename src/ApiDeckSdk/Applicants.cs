...
namespace ApiDeckSdk
{
    ...
    public class Applicants: IApplicants
    {
        ...
        public Applicants(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AtsApplicantsAddResponse> CreateAsync(AtsApplicantsAddRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("ats.applicantsAdd", null, _securitySource);
