...
namespace ApiDeckSdk
{
    ...
    public class Products: IProducts
    {
        ...
        public Products(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<EcommerceProductsAllResponse> ListAsync(EcommerceProductsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("ecommerce.productsAll", null, _securitySource);
