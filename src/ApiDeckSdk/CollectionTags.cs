...
namespace ApiDeckSdk
{
    ...
    public interface ICollectionTags
    {
        ...
        /// </remarks>
        /// </summary>
        Task<IssueTrackingCollectionTagsAllResponse> ListAsync(IssueTrackingCollectionTagsAllRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CollectionTags: ICollectionTags
    {
        ...
        public CollectionTags(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<IssueTrackingCollectionTagsAllResponse> ListAsync(IssueTrackingCollectionTagsAllRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetCollectionTagsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
