...
namespace ApiDeckSdk
{
    ...
    public interface IApiResources
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ConnectorApiResourcesOneResponse> GetAsync(string id, string resourceId, string? appId = null, RetryConfig? retryConfig = null);
    }
    ...
    public class ApiResources: IApiResources
    {
        ...
        public ApiResources(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ConnectorApiResourcesOneResponse> GetAsync(string id, string resourceId, string? appId = null, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/connector/apis/{id}/resources/{resource_id}", request);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetApiResourceResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
