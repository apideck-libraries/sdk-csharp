...
namespace ApiDeckSdk
{
    ...
    public class ProfitAndLoss: IProfitAndLoss
    {
        ...
        public ProfitAndLoss(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AccountingProfitAndLossOneResponse> GetAsync(AccountingProfitAndLossOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetProfitAndLossResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
