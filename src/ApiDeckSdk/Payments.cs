...
namespace ApiDeckSdk
{
    ...
    public class Payments: IPayments
    {
        ...
        public Payments(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AccountingPaymentsUpdateResponse> UpdateAsync(AccountingPaymentsUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("accounting.paymentsUpdate", null, _securitySource);
