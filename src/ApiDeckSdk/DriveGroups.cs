...
namespace ApiDeckSdk
{
    ...
    public class DriveGroups: IDriveGroups
    {
        ...
        public DriveGroups(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<FileStorageDriveGroupsAddResponse> CreateAsync(FileStorageDriveGroupsAddRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("fileStorage.driveGroupsAdd", null, _securitySource);
        ...
        public async Task<FileStorageDriveGroupsOneResponse> GetAsync(FileStorageDriveGroupsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("fileStorage.driveGroupsOne", null, _securitySource);
