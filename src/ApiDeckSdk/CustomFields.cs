...
namespace ApiDeckSdk
{
    ...
    public interface ICustomFields
    {
        ...
        /// 
        /// <remarks>
        /// This endpoint returns an custom fields on a connection resource.<br/>
        /// 
        /// </remarks>
        /// </summary>
        Task<VaultCustomFieldsAllResponse> ListAsync(VaultCustomFieldsAllRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CustomFields: ICustomFields
    {
        ...
        public CustomFields(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<VaultCustomFieldsAllResponse> ListAsync(VaultCustomFieldsAllRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
                request = new VaultCustomFieldsAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/vault/connections/{unified_api}/{service_id}/{resource}/custom-fields", request);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetCustomFieldsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new VaultCustomFieldsAllResponse()
                    {
                    ...
                    response.GetCustomFieldsResponse = obj;
                    return response;
                }
