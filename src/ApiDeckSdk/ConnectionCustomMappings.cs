...
namespace ApiDeckSdk
{
    ...
    public class ConnectionCustomMappings: IConnectionCustomMappings
    {
        ...
        public ConnectionCustomMappings(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<VaultConnectionCustomMappingsAllResponse> ListAsync(VaultConnectionCustomMappingsAllRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetCustomMappingsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
