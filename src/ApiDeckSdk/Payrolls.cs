...
namespace ApiDeckSdk
{
    ...
    public class Payrolls: IPayrolls
    {
        ...
        public Payrolls(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<HrisPayrollsAllResponse> ListAsync(HrisPayrollsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("hris.payrollsAll", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetPayrollsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<HrisPayrollsOneResponse> GetAsync(HrisPayrollsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("hris.payrollsOne", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetPayrollResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
