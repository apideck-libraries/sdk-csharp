...
namespace ApiDeckSdk
{
    ...
    public class Orders: IOrders
    {
        ...
        public Orders(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<EcommerceOrdersOneResponse> GetAsync(EcommerceOrdersOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("ecommerce.ordersOne", null, _securitySource);
