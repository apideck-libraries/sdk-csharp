...
namespace ApiDeckSdk
{
    ...
    public class Pipelines: IPipelines
    {
        ...
        public Pipelines(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CrmPipelinesDeleteResponse> DeleteAsync(CrmPipelinesDeleteRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("crm.pipelinesDelete", null, _securitySource);
