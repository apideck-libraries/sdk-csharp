...
namespace ApiDeckSdk
{
    ...
    public class Connections: IConnections
    {
        ...
        public Connections(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<VaultConnectionsUpdateResponse> UpdateAsync(VaultConnectionsUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("vault.connectionsUpdate", null, _securitySource);
