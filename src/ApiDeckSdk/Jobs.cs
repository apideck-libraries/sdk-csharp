...
namespace ApiDeckSdk
{
    ...
    public class Jobs: IJobs
    {
        ...
        public Jobs(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AtsJobsAllResponse> ListAsync(AtsJobsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetJobsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<AtsJobsOneResponse> GetAsync(AtsJobsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("ats.jobsOne", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetJobResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
