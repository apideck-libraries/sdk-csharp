...
namespace ApiDeckSdk
{
    ...
    public class Companies: ICompanies
    {
        ...
        public Companies(ISpeakeasyHttpClient client, Func<ApiDeckSdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CrmCompaniesAllResponse> ListAsync(CrmCompaniesAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("crm.companiesAll", null, _securitySource);
