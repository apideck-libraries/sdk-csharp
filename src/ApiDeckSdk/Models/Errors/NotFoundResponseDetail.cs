...
namespace ApiDeckSdk.Models.Errors
{
    ...
    public class NotFoundResponseDetailType
    {
        ...
        public static implicit operator String(NotFoundResponseDetailType v) { return v.Value; }
        public static NotFoundResponseDetailType FromString(string v) {
            switch(v) {
                case "str": return Str;
                case "mapOfAny": return MapOfAny;
                case "null": return Null;
                default: throw new ArgumentException("Invalid value for NotFoundResponseDetailType");
            }
        }
        public override bool Equals(object? obj)
        {
            ...
            return Value.Equals(((NotFoundResponseDetailType)obj).Value);
        }
    ...
    public class NotFoundResponseDetail {
        ...
        public class NotFoundResponseDetailConverter : JsonConverter
        {

            public override bool CanConvert(System.Type objectType) => objectType == typeof(NotFoundResponseDetail);
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                if (json[0] == '"' && json[^1] == '"'){
                    return new NotFoundResponseDetail(NotFoundResponseDetailType.Str)
                    {
                        Str = json[1..^1]
                    };
                }
                ...
                try
                {
                    return new NotFoundResponseDetail(NotFoundResponseDetailType.MapOfAny)
                    {
                ...
                {
                    fallbackCandidates.Add((typeof(Dictionary<string, object>), new NotFoundResponseDetail(NotFoundResponseDetailType.MapOfAny), "MapOfAny"));
                }
