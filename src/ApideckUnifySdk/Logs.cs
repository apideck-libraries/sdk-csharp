...
namespace ApideckUnifySdk
{
    ...
    public interface ILogs
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="VaultLogsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="VaultLogsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<VaultLogsAllResponse> ListAsync(
            VaultLogsAllRequest? request = null,
    ...
    public class Logs: ILogs
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<VaultLogsAllResponse> ListAsync(
            VaultLogsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/vault/logs", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "vault.logsAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetLogsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetLogsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
