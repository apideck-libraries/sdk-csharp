...
namespace ApideckUnifySdk
{
    ...
    public interface IAgedCreditors
    {
        ...
        /// Get Aged Creditors.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingAgedCreditorsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingAgedCreditorsOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingAgedCreditorsOneResponse> GetAsync(
            AccountingAgedCreditorsOneRequest? request = null,
    ...
    public class AgedCreditors: IAgedCreditors
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingAgedCreditorsOneResponse> GetAsync(
            AccountingAgedCreditorsOneRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/accounting/aged-creditors", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.agedCreditorsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetAgedCreditorsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetAgedCreditorsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
