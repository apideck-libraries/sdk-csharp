...
namespace ApideckUnifySdk
{
    ...
    public interface ILists
    {
        ...
        /// List lists.
        /// </remarks>
        /// <param name="request">A <see cref="CrmListsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="CrmListsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<CrmListsAllResponse> ListAsync(CrmListsAllRequest? request = null, RetryConfig? retryConfig = null);
        ...
        /// Get list.
        /// </remarks>
        /// <param name="request">A <see cref="CrmListsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="CrmListsOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<CrmListsOneResponse> GetAsync(CrmListsOneRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Lists: ILists
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CrmListsAllResponse> ListAsync(
            CrmListsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new CrmListsAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/crm/lists", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.listsAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<CrmListsAllResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new CrmListsAllRequest
                {
                    Raw = request?.Raw,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetListsResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetListsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetListsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new CrmListsAllResponse()
                    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CrmListsOneResponse> GetAsync(CrmListsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/crm/lists/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.listsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetListResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetListResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new CrmListsOneResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
