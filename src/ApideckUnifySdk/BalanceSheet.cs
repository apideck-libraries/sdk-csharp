...
namespace ApideckUnifySdk
{
    ...
    public interface IBalanceSheet
    {
        ...
        /// Get BalanceSheet.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingBalanceSheetOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingBalanceSheetOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingBalanceSheetOneResponse> GetAsync(
            AccountingBalanceSheetOneRequest? request = null,
    ...
    public class BalanceSheet: IBalanceSheet
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingBalanceSheetOneResponse> GetAsync(
            AccountingBalanceSheetOneRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/accounting/balance-sheet", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.balanceSheetOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetBalanceSheetResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetBalanceSheetResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
