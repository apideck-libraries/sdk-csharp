    ...
    public class Quotes: IQuotes
    {
        ...
        public async Task<AccountingQuotesAllResponse> ListAsync(AccountingQuotesAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetQuotesResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<AccountingQuotesAddResponse> CreateAsync(AccountingQuotesAddRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CreateQuoteResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<AccountingQuotesOneResponse> GetAsync(AccountingQuotesOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetQuoteResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<AccountingQuotesUpdateResponse> UpdateAsync(AccountingQuotesUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<UpdateQuoteResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<AccountingQuotesDeleteResponse> DeleteAsync(AccountingQuotesDeleteRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<DeleteQuoteResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
