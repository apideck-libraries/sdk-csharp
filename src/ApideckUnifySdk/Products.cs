...
namespace ApideckUnifySdk
{
    ...
    public class Products: IProducts
    {
        ...
        public Products(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<EcommerceProductsAllResponse> ListAsync(EcommerceProductsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "ecommerce.productsAll", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetProductsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<EcommerceProductsOneResponse> GetAsync(EcommerceProductsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "ecommerce.productsOne", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetProductResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
