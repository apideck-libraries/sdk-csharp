...
namespace ApideckUnifySdk
{
    ...
    public interface IProducts
    {
        ...
        /// List Products.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceProductsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceProductsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<EcommerceProductsAllResponse> ListAsync(
            EcommerceProductsAllRequest? request = null,
        ...
        /// Get Product.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceProductsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceProductsOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<EcommerceProductsOneResponse> GetAsync(
    ...
    public class Products: IProducts
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceProductsAllResponse> ListAsync(
            EcommerceProductsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new EcommerceProductsAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/products", request, null);
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceProductsOneResponse> GetAsync(
            EcommerceProductsOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/products/{id}", request, null);
