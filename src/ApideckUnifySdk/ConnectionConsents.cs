...
namespace ApideckUnifySdk
{
    ...
    public interface IConnectionConsents
    {
        ...
        /// </remarks>
        /// </summary>
        Task<VaultConnectionConsentsAllResponse> ListAsync(string serviceId, string unifiedApi, string? consumerId = null, string? appId = null, RetryConfig? retryConfig = null);
    }
