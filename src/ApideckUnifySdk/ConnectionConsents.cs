...
namespace ApideckUnifySdk
{
    ...
    public interface IConnectionConsents
    {
        /// <summary>
        /// Get consent records.
        /// </summary>
        ...
        /// <returns>An awaitable task that returns a <see cref="VaultConnectionConsentsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<VaultConnectionConsentsAllResponse> ListAsync(
            string serviceId,
            string unifiedApi,
    ...
    public class ConnectionConsents: IConnectionConsents
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public ConnectionConsents(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<VaultConnectionConsentsAllResponse> ListAsync(
            string serviceId,
            string unifiedApi,
            string? consumerId = null,
            string? appId = null,
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "vault.connectionConsentsAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetConsentRecordsResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetConsentRecordsResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetConsentRecordsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new VaultConnectionConsentsAllResponse()
                    {
                    ...
                    response.GetConsentRecordsResponse = obj;
                    return response;
                }
