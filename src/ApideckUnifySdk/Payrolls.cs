...
namespace ApideckUnifySdk
{
    ...
    public class Payrolls: IPayrolls
    {
        ...
        public async Task<HrisPayrollsAllResponse> ListAsync(HrisPayrollsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris.payrollsAll", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<HrisPayrollsOneResponse> GetAsync(HrisPayrollsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris.payrollsOne", new List<string> {  }, SDKConfiguration.SecuritySource);
