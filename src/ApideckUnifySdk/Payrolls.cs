...
namespace ApideckUnifySdk
{
    ...
    public interface IPayrolls
    {
        ...
        /// List Payroll.
        /// </remarks>
        /// <param name="request">A <see cref="HrisPayrollsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisPayrollsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisPayrollsAllResponse> ListAsync(
            HrisPayrollsAllRequest? request = null,
        ...
        /// Get Payroll.
        /// </remarks>
        /// <param name="request">A <see cref="HrisPayrollsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisPayrollsOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<HrisPayrollsOneResponse> GetAsync(HrisPayrollsOneRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Payrolls: IPayrolls
    {
        ...
        public Payrolls(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisPayrollsAllResponse> ListAsync(
            HrisPayrollsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new HrisPayrollsAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/hris/payrolls", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris.payrollsAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetPayrollsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetPayrollsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new HrisPayrollsAllResponse()
                    {
                    ...
                    response.GetPayrollsResponse = obj;
                    return response;
                }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisPayrollsOneResponse> GetAsync(
        ...
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/hris/payrolls/{payroll_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris.payrollsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetPayrollResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetPayrollResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new HrisPayrollsOneResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.GetPayrollResponse = obj;
                    return response;
                }
