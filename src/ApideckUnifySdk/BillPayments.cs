...
namespace ApideckUnifySdk
{
    ...
    public class BillPayments: IBillPayments
    {
        ...
        public async Task<AccountingBillPaymentsAllResponse> ListAsync(AccountingBillPaymentsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.billPaymentsAll", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AccountingBillPaymentsAddResponse> CreateAsync(AccountingBillPaymentsAddRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.billPaymentsAdd", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AccountingBillPaymentsOneResponse> GetAsync(AccountingBillPaymentsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.billPaymentsOne", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AccountingBillPaymentsUpdateResponse> UpdateAsync(AccountingBillPaymentsUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.billPaymentsUpdate", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AccountingBillPaymentsDeleteResponse> DeleteAsync(AccountingBillPaymentsDeleteRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.billPaymentsDelete", new List<string> {  }, SDKConfiguration.SecuritySource);
