...
namespace ApideckUnifySdk
{
    ...
    public class ConnectorDocs: IConnectorDocs
    {
        ...
        public ConnectorDocs(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ConnectorConnectorDocsOneResponse> GetAsync(string id, string docId, string? appId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "connector.connectorDocsOne", new List<string> {  }, _securitySource);
