...
namespace ApideckUnifySdk
{
    ...
    public class CustomMappings: ICustomMappings
    {
        ...
        public CustomMappings(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<VaultCustomMappingsAllResponse> ListAsync(string unifiedApi, string serviceId, string? consumerId = null, string? appId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "vault.customMappingsAll", new List<string> {  }, _securitySource);
