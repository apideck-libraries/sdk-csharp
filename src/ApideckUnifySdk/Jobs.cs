...
namespace ApideckUnifySdk
{
    ...
    public class Jobs: IJobs
    {
        ...
        public Jobs(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AtsJobsAllResponse> ListAsync(AtsJobsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "ats.jobsAll", new List<string> {  }, _securitySource);
        ...
        public async Task<AtsJobsOneResponse> GetAsync(AtsJobsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "ats.jobsOne", new List<string> {  }, _securitySource);
