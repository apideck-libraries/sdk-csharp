...
namespace ApideckUnifySdk
{
    ...
    public class ConnectionCustomMappings: IConnectionCustomMappings
    {
        ...
        public ConnectionCustomMappings(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<VaultConnectionCustomMappingsAllResponse> ListAsync(VaultConnectionCustomMappingsAllRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "vault.connectionCustomMappingsAll", new List<string> {  }, _securitySource);
