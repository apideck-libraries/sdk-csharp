...
namespace ApideckUnifySdk
{
    ...
    public interface IConnectionCustomMappings
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="VaultConnectionCustomMappingsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="VaultConnectionCustomMappingsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<VaultConnectionCustomMappingsAllResponse> ListAsync(
    ...
    public class ConnectionCustomMappings: IConnectionCustomMappings
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<VaultConnectionCustomMappingsAllResponse> ListAsync(
            VaultConnectionCustomMappingsAllRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/vault/connections/{unified_api}/{service_id}/{resource}/custom-mappings", request, null);
