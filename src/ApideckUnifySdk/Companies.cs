...
namespace ApideckUnifySdk
{
    ...
    public interface ICompanies
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CrmCompaniesAllResponse> ListAsync(CrmCompaniesAllRequest? request = null, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CrmCompaniesAddResponse> CreateAsync(CrmCompaniesAddRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CrmCompaniesOneResponse> GetAsync(CrmCompaniesOneRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CrmCompaniesUpdateResponse> UpdateAsync(CrmCompaniesUpdateRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CrmCompaniesDeleteResponse> DeleteAsync(CrmCompaniesDeleteRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Companies: ICompanies
    {
        ...
        public async Task<CrmCompaniesAllResponse> ListAsync(CrmCompaniesAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/crm/companies", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.companiesAll", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCompaniesResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCompaniesResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
                    ...
                    response.GetCompaniesResponse = obj;
                    return response;
                }
        ...
        public async Task<CrmCompaniesAddResponse> CreateAsync(CrmCompaniesAddRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
                request = new CrmCompaniesAddRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.companiesAdd", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<CrmCompaniesOneResponse> GetAsync(CrmCompaniesOneRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
                request = new CrmCompaniesOneRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/crm/companies/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.companiesOne", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<CrmCompaniesUpdateResponse> UpdateAsync(CrmCompaniesUpdateRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
                request = new CrmCompaniesUpdateRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.companiesUpdate", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<CrmCompaniesDeleteResponse> DeleteAsync(CrmCompaniesDeleteRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
                request = new CrmCompaniesDeleteRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm.companiesDelete", new List<string> {  }, SDKConfiguration.SecuritySource);
