...
namespace ApideckUnifySdk
{
    ...
    public interface ICompanies
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="AccountingCompaniesAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingCompaniesAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingCompaniesAllResponse> ListAsync(
            AccountingCompaniesAllRequest? request = null,
    ...
    public class Companies: ICompanies
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingCompaniesAllResponse> ListAsync(
            AccountingCompaniesAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new AccountingCompaniesAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/companies", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.companiesAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AccountingCompaniesAllResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AccountingCompaniesAllRequest
                {
                    Raw = request?.Raw,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AccountingCompaniesAllResponse()
                    {
