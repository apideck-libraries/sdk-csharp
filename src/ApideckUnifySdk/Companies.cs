    ...
    public class Companies: ICompanies
    {
        ...
        public async Task<CrmCompaniesAllResponse> ListAsync(CrmCompaniesAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetCompaniesResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<CrmCompaniesAddResponse> CreateAsync(CrmCompaniesAddRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CreateCompanyResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<CrmCompaniesOneResponse> GetAsync(CrmCompaniesOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetCompanyResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<CrmCompaniesUpdateResponse> UpdateAsync(CrmCompaniesUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<UpdateCompanyResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<CrmCompaniesDeleteResponse> DeleteAsync(CrmCompaniesDeleteRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<DeleteCompanyResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
