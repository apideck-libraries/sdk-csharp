...
namespace ApideckUnifySdk
{
    ...
    public interface IStores
    {
        ...
        /// Get Store.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceStoresOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceStoresOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<EcommerceStoresOneResponse> GetAsync(
            EcommerceStoresOneRequest? request = null,
    ...
    public class Stores: IStores
    {
        ...
        public Stores(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceStoresOneResponse> GetAsync(
            EcommerceStoresOneRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new EcommerceStoresOneRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/store", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ecommerce.storesOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetStoreResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetStoreResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetStoreResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new EcommerceStoresOneResponse()
                    {
