...
namespace ApideckUnifySdk
{
    ...
    public interface IStores
    {
        ...
        /// </remarks>
        /// </summary>
        Task<EcommerceStoresOneResponse> GetAsync(EcommerceStoresOneRequest? request = null, RetryConfig? retryConfig = null);
    }
    ...
    public class Stores: IStores
    {
        ...
        public async Task<EcommerceStoresOneResponse> GetAsync(EcommerceStoresOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/store", request);
