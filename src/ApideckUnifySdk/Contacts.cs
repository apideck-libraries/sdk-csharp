    ...
    public class Contacts: IContacts
    {
        ...
        public async Task<CrmContactsAllResponse> ListAsync(CrmContactsAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetContactsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<CrmContactsAddResponse> CreateAsync(CrmContactsAddRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CreateContactResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<CrmContactsOneResponse> GetAsync(CrmContactsOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetContactResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<CrmContactsUpdateResponse> UpdateAsync(CrmContactsUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<UpdateContactResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<CrmContactsDeleteResponse> DeleteAsync(CrmContactsDeleteRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<DeleteContactResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
