...
namespace ApideckUnifySdk.Models.Requests
{
    ...
    public class AccountingGeneralLedgerTransactionsAllRequest
    {
        /// <summary>
        ...
        public GeneralLedgerTransactionsFilter? Filter { get; set; }

        /// <summary>
        /// Apply sorting.
        /// </summary>
        [SpeakeasyMetadata("queryParam:style=deepObject,explode=true,name=sort")]
        public GeneralLedgerTransactionsSort? Sort { get; set; }
