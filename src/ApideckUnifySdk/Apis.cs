...
namespace ApideckUnifySdk
{
    ...
    public class Apis: IApis
    {
        ...
        public Apis(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ConnectorApisAllResponse> ListAsync(string? appId = null, string? cursor = null, long? limit = 20, ApisFilter? filter = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "connector.apisAll", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetApisResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<ConnectorApisOneResponse> GetAsync(string id, string? appId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "connector.apisOne", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetApiResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
