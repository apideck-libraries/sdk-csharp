...
namespace ApideckUnifySdk
{
    ...
    public class Apis: IApis
    {
        ...
        public async Task<ConnectorApisAllResponse> ListAsync(string? appId = null, string? cursor = null, long? limit = 20, ApisFilter? filter = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "connector.apisAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<ConnectorApisAllResponse?>> nextFunc = async delegate()
            {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetApisResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetApisResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new ConnectorApisAllResponse()
                    {
        ...
        {
            var request = new ConnectorApisOneRequest()
            {
                Id = id,
                AppId = appId,
            };
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "connector.apisOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetApiResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetApiResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new ConnectorApisOneResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
