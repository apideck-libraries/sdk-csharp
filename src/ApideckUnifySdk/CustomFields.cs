...
namespace ApideckUnifySdk
{
    ...
    public interface ICustomFields
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="VaultCustomFieldsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="VaultCustomFieldsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<VaultCustomFieldsAllResponse> ListAsync(
    ...
    public class CustomFields: ICustomFields
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<VaultCustomFieldsAllResponse> ListAsync(
            VaultCustomFieldsAllRequest request,
            RetryConfig? retryConfig = null
        )
        {
