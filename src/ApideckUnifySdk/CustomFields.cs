...
namespace ApideckUnifySdk
{
    ...
    public class CustomFields: ICustomFields
    {
        ...
        public async Task<VaultCustomFieldsAllResponse> ListAsync(VaultCustomFieldsAllRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "vault.customFieldsAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetCustomFieldsResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCustomFieldsResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCustomFieldsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
