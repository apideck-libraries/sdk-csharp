...
namespace ApideckUnifySdk
{
    ...
    public interface IConnectionConsent
    {
        ...
        /// </remarks>
        /// </summary>
        Task<VaultConnectionConsentUpdateResponse> UpdateAsync(VaultConnectionConsentUpdateRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class ConnectionConsent: IConnectionConsent
    {
        ...
        public async Task<VaultConnectionConsentUpdateResponse> UpdateAsync(VaultConnectionConsentUpdateRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/vault/connections/{unified_api}/{service_id}/consent", request);
