...
namespace ApideckUnifySdk
{
    ...
    public interface IGoodsReceipts
    {
        ...
        /// List Goods Receipts.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingGoodsReceiptsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingGoodsReceiptsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingGoodsReceiptsAllResponse> ListAsync(
            AccountingGoodsReceiptsAllRequest? request = null,
        ...
        /// Get Goods Receipt.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingGoodsReceiptsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingGoodsReceiptsOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AccountingGoodsReceiptsOneResponse> GetAsync(
            AccountingGoodsReceiptsOneRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class GoodsReceipts: IGoodsReceipts
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public GoodsReceipts(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingGoodsReceiptsAllResponse> ListAsync(
            AccountingGoodsReceiptsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new AccountingGoodsReceiptsAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/goods-receipts", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.goodsReceiptsAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AccountingGoodsReceiptsAllResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AccountingGoodsReceiptsAllRequest
                {
                    Raw = request?.Raw,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetGoodsReceiptsResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetGoodsReceiptsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetGoodsReceiptsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AccountingGoodsReceiptsAllResponse()
                    {
                    ...
                    response.GetGoodsReceiptsResponse = obj;
                    return response;
                }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingGoodsReceiptsOneResponse> GetAsync(
            AccountingGoodsReceiptsOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/goods-receipts/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.goodsReceiptsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    GetGoodsReceiptResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetGoodsReceiptResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetGoodsReceiptResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AccountingGoodsReceiptsOneResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.GetGoodsReceiptResponse = obj;
                    return response;
                }
