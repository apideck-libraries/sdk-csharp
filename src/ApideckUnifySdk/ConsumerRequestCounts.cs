...
namespace ApideckUnifySdk
{
    ...
    public interface IConsumerRequestCounts
    {
        /// <summary>
        ...
        /// <returns>An awaitable task that returns a <see cref="VaultConsumerRequestCountsAllResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="consumerId"/>, <paramref name="startDatetime"/> or <paramref name="endDatetime"/> is null.</exception>
        ...
        public  Task<VaultConsumerRequestCountsAllResponse> ListAsync(
            string consumerId,
    ...
    public class ConsumerRequestCounts: IConsumerRequestCounts
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public ConsumerRequestCounts(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<VaultConsumerRequestCountsAllResponse> ListAsync(
            string consumerId,
            string startDatetime,
            string endDatetime,
            string? appId = null,
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/vault/consumers/{consumer_id}/stats", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "vault.consumerRequestCountsAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ConsumerRequestCountsInDateRangeResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ConsumerRequestCountsInDateRangeResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new VaultConsumerRequestCountsAllResponse()
                    {
                    ...
                    response.ConsumerRequestCountsInDateRangeResponse = obj;
                    return response;
                }
