...
namespace ApideckUnifySdk
{
    ...
    public interface IProfitAndLoss
    {
        ...
        /// </remarks>
        /// </summary>
        Task<AccountingProfitAndLossOneResponse> GetAsync(AccountingProfitAndLossOneRequest? request = null, RetryConfig? retryConfig = null);
    }
    ...
    public class ProfitAndLoss: IProfitAndLoss
    {
        ...
        public async Task<AccountingProfitAndLossOneResponse> GetAsync(AccountingProfitAndLossOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
