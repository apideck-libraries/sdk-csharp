...
namespace ApideckUnifySdk
{
    ...
    public class ProfitAndLoss: IProfitAndLoss
    {
        ...
        public ProfitAndLoss(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AccountingProfitAndLossOneResponse> GetAsync(AccountingProfitAndLossOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "accounting.profitAndLossOne", new List<string> {  }, _securitySource);
