...
namespace ApideckUnifySdk
{
    ...
    public interface IProfitAndLoss
    {
        ...
        /// Get Profit and Loss.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingProfitAndLossOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingProfitAndLossOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingProfitAndLossOneResponse> GetAsync(
            AccountingProfitAndLossOneRequest? request = null,
    ...
    public class ProfitAndLoss: IProfitAndLoss
    {
        ...
        public ProfitAndLoss(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingProfitAndLossOneResponse> GetAsync(
            AccountingProfitAndLossOneRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new AccountingProfitAndLossOneRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/profit-and-loss", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.profitAndLossOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetProfitAndLossResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetProfitAndLossResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AccountingProfitAndLossOneResponse()
                    {
                    ...
                    response.GetProfitAndLossResponse = obj;
                    return response;
                }
