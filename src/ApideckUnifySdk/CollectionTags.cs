...
namespace ApideckUnifySdk
{
    ...
    public interface ICollectionTags
    {
        /// <summary>
        /// List Tags.
        /// </summary>
        ...
        /// List Tags.
        /// </remarks>
        /// <param name="request">A <see cref="IssueTrackingCollectionTagsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IssueTrackingCollectionTagsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<IssueTrackingCollectionTagsAllResponse> ListAsync(
            IssueTrackingCollectionTagsAllRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class CollectionTags: ICollectionTags
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IssueTrackingCollectionTagsAllResponse> ListAsync(
            IssueTrackingCollectionTagsAllRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionTagsAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<IssueTrackingCollectionTagsAllResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new IssueTrackingCollectionTagsAllRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCollectionTagsResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCollectionTagsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new IssueTrackingCollectionTagsAllResponse()
                    {
                    ...
                    response.GetCollectionTagsResponse = obj;
                    return response;
                }
