...
namespace ApideckUnifySdk
{
    ...
    public class Orders: IOrders
    {
        ...
        public Orders(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<EcommerceOrdersAllResponse> ListAsync(EcommerceOrdersAllRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "ecommerce.ordersAll", new List<string> {  }, _securitySource);
        ...
        public async Task<EcommerceOrdersOneResponse> GetAsync(EcommerceOrdersOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "ecommerce.ordersOne", new List<string> {  }, _securitySource);
