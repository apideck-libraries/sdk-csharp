...
namespace ApideckUnifySdk
{
    ...
    public interface IOrders
    {
        ...
        /// List Orders.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceOrdersAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceOrdersAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<EcommerceOrdersAllResponse> ListAsync(
            EcommerceOrdersAllRequest? request = null,
        ...
        /// Get Order.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceOrdersOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceOrdersOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<EcommerceOrdersOneResponse> GetAsync(
    ...
    public class Orders: IOrders
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceOrdersAllResponse> ListAsync(
            EcommerceOrdersAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new EcommerceOrdersAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/orders", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ecommerce.ordersAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetEcommerceOrdersResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetEcommerceOrdersResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceOrdersOneResponse> GetAsync(
            EcommerceOrdersOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/orders/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ecommerce.ordersOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetEcommerceOrderResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetEcommerceOrderResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
