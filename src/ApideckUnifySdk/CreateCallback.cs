...
namespace ApideckUnifySdk
{
    ...
    public interface ICreateCallback
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="VaultCreateCallbackStateRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="VaultCreateCallbackStateResponse"/> response envelope when completed.</returns>
        ...
        public  Task<VaultCreateCallbackStateResponse> StateAsync(
    ...
    public class CreateCallback: ICreateCallback
    {
        ...
        public CreateCallback(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<VaultCreateCallbackStateResponse> StateAsync(
            VaultCreateCallbackStateRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/vault/connections/{unified_api}/{service_id}/callback-state", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "vault.createCallbackState", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    CreateCallbackStateResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CreateCallbackStateResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CreateCallbackStateResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
