...
namespace ApideckUnifySdk
{
    ...
    public class ApiResourceCoverage: IApiResourceCoverage
    {
        ...
        public ApiResourceCoverage(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
