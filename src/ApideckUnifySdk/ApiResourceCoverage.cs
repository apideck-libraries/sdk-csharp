...
namespace ApideckUnifySdk
{
    ...
    public interface IApiResourceCoverage
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="ConnectorApiResourceCoverageOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<ConnectorApiResourceCoverageOneResponse> GetAsync(
            string id,
            string resourceId,
            string? appId = null,
    ...
    public class ApiResourceCoverage: IApiResourceCoverage
    {
        ...
        /// <exception cref="NotFoundResponse">The specified resource was not found. Thrown when the API returns a 404 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ConnectorApiResourceCoverageOneResponse> GetAsync(
            string id,
            string resourceId,
            string? appId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "connector.apiResourceCoverageOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetApiResourceCoverageResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetApiResourceCoverageResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
