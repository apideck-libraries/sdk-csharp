...
namespace ApideckUnifySdk
{
    ...
    public interface ICollections
    {
        ...
        /// List Collections.
        /// </remarks>
        /// <param name="request">A <see cref="IssueTrackingCollectionsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IssueTrackingCollectionsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<IssueTrackingCollectionsAllResponse> ListAsync(
            IssueTrackingCollectionsAllRequest? request = null,
        ...
        /// Get Collection.
        /// </remarks>
        /// <param name="request">A <see cref="IssueTrackingCollectionsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IssueTrackingCollectionsOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<IssueTrackingCollectionsOneResponse> GetAsync(
    ...
    public class Collections: ICollections
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IssueTrackingCollectionsAllResponse> ListAsync(
            IssueTrackingCollectionsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/issue-tracking/collections", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionsAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCollectionsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCollectionsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IssueTrackingCollectionsOneResponse> GetAsync(
            IssueTrackingCollectionsOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/issue-tracking/collections/{collection_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCollectionResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCollectionResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
