...
namespace ApideckUnifySdk
{
    ...
    public interface IEmployeeSchedules
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="HrisEmployeeSchedulesAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisEmployeeSchedulesAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisEmployeeSchedulesAllResponse> ListAsync(
    ...
    public class EmployeeSchedules: IEmployeeSchedules
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisEmployeeSchedulesAllResponse> ListAsync(
            HrisEmployeeSchedulesAllRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/hris/schedules/employees/{employee_id}", request, null);
