...
namespace ApideckUnifySdk
{
    ...
    public class CompanyInfo: ICompanyInfo
    {
        ...
        public CompanyInfo(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AccountingCompanyInfoOneResponse> GetAsync(AccountingCompanyInfoOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "accounting.companyInfoOne", new List<string> {  }, _securitySource);
