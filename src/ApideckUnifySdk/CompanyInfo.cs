...
namespace ApideckUnifySdk
{
    ...
    public interface ICompanyInfo
    {
        ...
        /// Get company info.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingCompanyInfoOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingCompanyInfoOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingCompanyInfoOneResponse> GetAsync(
            AccountingCompanyInfoOneRequest? request = null,
    ...
    public class CompanyInfo: ICompanyInfo
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingCompanyInfoOneResponse> GetAsync(
            AccountingCompanyInfoOneRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/accounting/company-info", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.companyInfoOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetCompanyInfoResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCompanyInfoResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCompanyInfoResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
