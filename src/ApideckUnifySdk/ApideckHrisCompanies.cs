...
namespace ApideckUnifySdk
{
    ...
    public interface IApideckHrisCompanies
    {
        /// <summary>
        /// List Companies.
        /// </summary>
        ...
        /// List Companies.
        /// </remarks>
        /// <param name="request">A <see cref="HrisCompaniesAll2Request"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisCompaniesAll2Response"/> response envelope when completed.</returns>
        ...
        public  Task<HrisCompaniesAll2Response> AllAsync(
            HrisCompaniesAll2Request? request = null,
    ...
    public class ApideckHrisCompanies: IApideckHrisCompanies
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public ApideckHrisCompanies(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisCompaniesAll2Response> AllAsync(
            HrisCompaniesAll2Request? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new HrisCompaniesAll2Request();
            }
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris.companiesAll2", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisCompaniesAll2Response?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisCompaniesAll2Request
                {
                    Raw = request?.Raw,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisCompaniesAll2Response()
                    {
