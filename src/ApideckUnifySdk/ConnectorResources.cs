...
namespace ApideckUnifySdk
{
    ...
    public class ConnectorResources: IConnectorResources
    {
        ...
        public ConnectorResources(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ConnectorConnectorResourcesOneResponse> GetAsync(string id, string resourceId, string? appId = null, UnifiedApiId? unifiedApi = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "connector.connectorResourcesOne", new List<string> {  }, _securitySource);
