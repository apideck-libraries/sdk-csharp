...
namespace ApideckUnifySdk
{
    ...
    public interface IGeneralLedgerTransactions
    {
        /// <summary>
        ...
        /// List General Ledger Transactions.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingGeneralLedgerTransactionsAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingGeneralLedgerTransactionsAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingGeneralLedgerTransactionsAllResponse> ListAsync(
            AccountingGeneralLedgerTransactionsAllRequest? request = null,
        ...
        /// Get General Ledger Transaction.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingGeneralLedgerTransactionsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingGeneralLedgerTransactionsOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AccountingGeneralLedgerTransactionsOneResponse> GetAsync(
            AccountingGeneralLedgerTransactionsOneRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class GeneralLedgerTransactions: IGeneralLedgerTransactions
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public GeneralLedgerTransactions(SDKConfig config)
        {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingGeneralLedgerTransactionsAllResponse> ListAsync(
            AccountingGeneralLedgerTransactionsAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new AccountingGeneralLedgerTransactionsAllRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/general-ledger-transactions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.generalLedgerTransactionsAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AccountingGeneralLedgerTransactionsAllResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AccountingGeneralLedgerTransactionsAllRequest
                {
                    Raw = request?.Raw,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GetGeneralLedgerTransactionsResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetGeneralLedgerTransactionsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetGeneralLedgerTransactionsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AccountingGeneralLedgerTransactionsAllResponse()
                    {
                    ...
                    response.GetGeneralLedgerTransactionsResponse = obj;
                    return response;
                }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingGeneralLedgerTransactionsOneResponse> GetAsync(
            AccountingGeneralLedgerTransactionsOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/general-ledger-transactions/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.generalLedgerTransactionsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    GetGeneralLedgerTransactionResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetGeneralLedgerTransactionResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetGeneralLedgerTransactionResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AccountingGeneralLedgerTransactionsOneResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.GetGeneralLedgerTransactionResponse = obj;
                    return response;
                }
