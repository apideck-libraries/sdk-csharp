...
namespace ApideckUnifySdk
{
    ...
    public class AgedDebtors: IAgedDebtors
    {
        ...
        public AgedDebtors(ISpeakeasyHttpClient client, Func<ApideckUnifySdk.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<AccountingAgedDebtorsOneResponse> GetAsync(AccountingAgedDebtorsOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("accounting.agedDebtorsOne", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<GetAgedDebtorsResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
