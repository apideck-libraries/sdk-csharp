...
namespace ApideckUnifySdk
{
    ...
    public interface IAgedDebtors
    {
        ...
        /// </remarks>
        /// </summary>
        Task<AccountingAgedDebtorsOneResponse> GetAsync(AccountingAgedDebtorsOneRequest? request = null, RetryConfig? retryConfig = null);
    }
    ...
    public class AgedDebtors: IAgedDebtors
    {
        ...
        public async Task<AccountingAgedDebtorsOneResponse> GetAsync(AccountingAgedDebtorsOneRequest? request = null, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
