...
namespace ApideckUnifySdk
{
    ...
    public interface IAgedDebtors
    {
        ...
        /// Get Aged Debtors.
        /// </remarks>
        /// <param name="request">A <see cref="AccountingAgedDebtorsOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AccountingAgedDebtorsOneResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AccountingAgedDebtorsOneResponse> GetAsync(
            AccountingAgedDebtorsOneRequest? request = null,
            RetryConfig? retryConfig = null
        );
    }

    public class AgedDebtors: IAgedDebtors
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AccountingAgedDebtorsOneResponse> GetAsync(
            AccountingAgedDebtorsOneRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            if (request == null)
            {
                request = new AccountingAgedDebtorsOneRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/accounting/aged-debtors", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "accounting.agedDebtorsOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetAgedDebtorsResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetAgedDebtorsResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AccountingAgedDebtorsOneResponse()
                    {
                    ...
                    response.GetAgedDebtorsResponse = obj;
                    return response;
                }
