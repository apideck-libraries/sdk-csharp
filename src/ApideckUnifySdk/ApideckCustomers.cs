...
namespace ApideckUnifySdk
{
    ...
    public interface IApideckCustomers
    {
        ...
        /// List Customers.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceCustomersAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceCustomersAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<EcommerceCustomersAllResponse> ListAsync(
            EcommerceCustomersAllRequest? request = null,
        ...
        /// Get Customer.
        /// </remarks>
        /// <param name="request">A <see cref="EcommerceCustomersOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="EcommerceCustomersOneResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<EcommerceCustomersOneResponse> GetAsync(
    ...
    public class ApideckCustomers: IApideckCustomers
    {
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceCustomersAllResponse> ListAsync(
            EcommerceCustomersAllRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/customers", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ecommerce.customersAll", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetEcommerceCustomersResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetEcommerceCustomersResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<EcommerceCustomersOneResponse> GetAsync(
            EcommerceCustomersOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/ecommerce/customers/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ecommerce.customersOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetEcommerceCustomerResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetEcommerceCustomerResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
