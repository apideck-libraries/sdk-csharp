...
namespace ApideckUnifySdk
{
    ...
    public interface ICollectionUsers
    {
        ...
        /// List Users.
        /// </remarks>
        /// <param name="request">A <see cref="IssueTrackingCollectionUsersAllRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IssueTrackingCollectionUsersAllResponse"/> response envelope when completed.</returns>
        ...
        public  Task<IssueTrackingCollectionUsersAllResponse> ListAsync(
        ...
        /// Get user.
        /// </remarks>
        /// <param name="request">A <see cref="IssueTrackingCollectionUsersOneRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IssueTrackingCollectionUsersOneResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponse">Bad Request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<IssueTrackingCollectionUsersOneResponse> GetAsync(
            IssueTrackingCollectionUsersOneRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class CollectionUsers: ICollectionUsers
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IssueTrackingCollectionUsersAllResponse> ListAsync(
            IssueTrackingCollectionUsersAllRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/issue-tracking/collections/{collection_id}/users", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionUsersAll", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<IssueTrackingCollectionUsersAllResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new IssueTrackingCollectionUsersAllRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCollectionUsersResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCollectionUsersResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new IssueTrackingCollectionUsersAllResponse()
                    {
                    ...
                    response.GetCollectionUsersResponse = obj;
                    return response;
                }
        ...
        /// <exception cref="UnprocessableResponse">Unprocessable. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IssueTrackingCollectionUsersOneResponse> GetAsync(
            IssueTrackingCollectionUsersOneRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/issue-tracking/collections/{collection_id}/users/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionUsersOne", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    GetCollectionUserResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GetCollectionUserResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GetCollectionUserResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new IssueTrackingCollectionUsersOneResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.GetCollectionUserResponse = obj;
                    return response;
                }
