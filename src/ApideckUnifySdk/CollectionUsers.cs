...
namespace ApideckUnifySdk
{
    ...
    public interface ICollectionUsers
    {
        ...
        /// </remarks>
        /// </summary>
        Task<IssueTrackingCollectionUsersAllResponse> ListAsync(IssueTrackingCollectionUsersAllRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<IssueTrackingCollectionUsersOneResponse> GetAsync(IssueTrackingCollectionUsersOneRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CollectionUsers: ICollectionUsers
    {
        ...
        public async Task<IssueTrackingCollectionUsersAllResponse> ListAsync(IssueTrackingCollectionUsersAllRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/issue-tracking/collections/{collection_id}/users", request);
        ...
        public async Task<IssueTrackingCollectionUsersOneResponse> GetAsync(IssueTrackingCollectionUsersOneRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null)
            {
                request = new IssueTrackingCollectionUsersOneRequest();
            }
            request.ConsumerId ??= SDKConfiguration.ConsumerId;
            request.AppId ??= SDKConfiguration.AppId;
            
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/issue-tracking/collections/{collection_id}/users/{id}", request);
