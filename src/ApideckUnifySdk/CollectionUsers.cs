...
namespace ApideckUnifySdk
{
    ...
    public class CollectionUsers: ICollectionUsers
    {
        ...
        public async Task<IssueTrackingCollectionUsersAllResponse> ListAsync(IssueTrackingCollectionUsersAllRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionUsersAll", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<IssueTrackingCollectionUsersOneResponse> GetAsync(IssueTrackingCollectionUsersOneRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issueTracking.collectionUsersOne", new List<string> {  }, SDKConfiguration.SecuritySource);
