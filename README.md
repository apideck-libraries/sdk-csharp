...
Developer-friendly & type-safe Csharp SDK specifically catered to leverage *Unify* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=unify&utm_campaign=csharp"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
```bash
dotnet add reference src/ApiDeckSdk/ApiDeckSdk.csproj
```
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=unify&utm_campaign=csharp)
