...
<!-- UsageSnippet language="csharp" operationID="fileStorage.uploadSessionsAdd" method="post" path="/file-storage/upload-sessions" -->
```csharp
...
<!-- UsageSnippet language="csharp" operationID="fileStorage.uploadSessionsOne" method="get" path="/file-storage/upload-sessions/{id}" -->
```csharp
using ApideckUnifySdk;
using ApideckUnifySdk.Models.Components;
using ApideckUnifySdk.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="fileStorage.uploadSessionsUpload" method="put" path="/file-storage/upload-sessions/{id}" -->
```csharp
using ApideckUnifySdk;
using ApideckUnifySdk.Models.Components;
using ApideckUnifySdk.Models.Requests;
...
| Parameter                                                                                                 | Type                                                                                                      | Required                                                                                                  | Description                                                                                               |
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                 | [FileStorageUploadSessionsUploadRequest](../../Models/Requests/FileStorageUploadSessionsUploadRequest.md) | :heavy_check_mark:                                                                                        | The request object to use for the request.                                                                |
| `serverURL`                                                                                               | *string*                                                                                                  | :heavy_minus_sign:                                                                                        | An optional server URL to use.                                                                            |

### Response

**[FileStorageUploadSessionsUploadResponse](../../Models/Requests/FileStorageUploadSessionsUploadResponse.md)**
...
<!-- UsageSnippet language="csharp" operationID="fileStorage.uploadSessionsDelete" method="delete" path="/file-storage/upload-sessions/{id}" -->
```csharp
using ApideckUnifySdk;
using ApideckUnifySdk.Models.Components;
using ApideckUnifySdk.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="fileStorage.uploadSessionsFinish" method="post" path="/file-storage/upload-sessions/{id}/finish" -->
```csharp
using ApideckUnifySdk;
using ApideckUnifySdk.Models.Components;
using ApideckUnifySdk.Models.Requests;
