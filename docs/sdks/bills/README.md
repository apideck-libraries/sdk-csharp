...
AccountingBillsAllRequest req = new AccountingBillsAllRequest() {
    ...
    Sort = new BillsSort() {
        By = ApiDeckSdk.Models.Components.By.UpdatedAt,
    ...
    Bill = new BillInput() {
        ...
        LineItems = new List<BillLineItemInput>() {
            new BillLineItemInput() {
                ...
                Type = ApiDeckSdk.Models.Components.BillLineItemType.ExpenseAccount,
                TaxAmount = 27500D,
                TotalAmount = 27500D,
                Quantity = 1D,
                UnitPrice = 27500.5D,
        ...
        Status = ApiDeckSdk.Models.Components.BillStatus.Draft,
        LedgerAccount = new LinkedLedgerAccountInput() {
            Id = "123456",
            NominalCode = "N091",
            Code = "453",
