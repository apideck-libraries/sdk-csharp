...
CrmActivitiesAllRequest req = new CrmActivitiesAllRequest() {
    ...
    Sort = new ActivitiesSort() {
        By = ApiDeckSdk.Models.Components.ActivitiesSortBy.CreatedAt,
...
CrmActivitiesAddRequest req = new CrmActivitiesAddRequest() {
    Activity = new ActivityInput() {
        ...
        Type = ApiDeckSdk.Models.Components.ActivityType.Meeting,
        Title = "Meeting",
        ...
        Archived = false,
        Deleted = false,
        ShowAs = ApiDeckSdk.Models.Components.ShowAs.Busy,
        Done = false,
        ...
        Attendees = new List<ActivityAttendeeInput>() {
            new ActivityAttendeeInput() {
                ...
                IsOrganizer = true,
                Status = ApiDeckSdk.Models.Components.ActivityAttendeeStatus.Accepted,
            },
        },
