...
AccountingInvoicesAllRequest req = new AccountingInvoicesAllRequest() {
    ...
    Sort = new InvoicesSort() {
        By = Apideck.Unify.SDK.Models.Components.InvoicesSortBy.UpdatedAt,
...
AccountingInvoicesAddRequest req = new AccountingInvoicesAddRequest() {
    Invoice = new InvoiceInput() {
        Type = Apideck.Unify.SDK.Models.Components.InvoiceType.Service,
        Number = "OIT00546",
        ...
        PoNumber = "90000117",
        Reference = "123456",
        Status = Apideck.Unify.SDK.Models.Components.InvoiceStatus.Draft,
        InvoiceSent = true,
        ...
        LineItems = new List<InvoiceLineItemInput>() {
            new InvoiceLineItemInput() {
                ...
                Type = Apideck.Unify.SDK.Models.Components.InvoiceLineItemType.SalesItem,
                TaxAmount = 27500D,
                TotalAmount = 27500D,
                Quantity = 1D,
                UnitPrice = 27500.5D,
