...
HrisTimeOffRequestsAllRequest req = new HrisTimeOffRequestsAllRequest() {
    ...
    Filter = new TimeOffRequestsFilter() {
        ...
        EmployeeId = "1234",
        TimeOffRequestStatus = Apideck.Unify.SDK.Models.Components.TimeOffRequestStatus.Approved,
        CompanyId = "1234",
    },
...
HrisTimeOffRequestsAddRequest req = new HrisTimeOffRequestsAddRequest() {
    TimeOffRequest = new TimeOffRequestInput() {
        EmployeeId = "12345",
        PolicyId = "12345",
        Status = Apideck.Unify.SDK.Models.Components.TimeOffRequestStatusStatus.Approved,
        Description = "Enjoying some sun.",
        StartDate = "2022-04-01",
        EndDate = "2022-04-01",
        RequestDate = "2022-03-21",
        RequestType = Apideck.Unify.SDK.Models.Components.RequestType.Vacation,
        ApprovalDate = "2022-03-21",
        Units = Apideck.Unify.SDK.Models.Components.Units.Hours,
        Amount = 3.5D,
        DayPart = "morning",
