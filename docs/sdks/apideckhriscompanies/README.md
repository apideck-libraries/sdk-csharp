...
<!-- UsageSnippet language="csharp" operationID="hris.companiesAll2" method="get" path="/hris/companies" -->
```csharp
...
HrisCompaniesAll2Request req = new HrisCompaniesAll2Request() {
...
HrisCompaniesAll2Response? res = await sdk.Hris.Companies.AllAsync(req);
...
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `request`                                                                     | [HrisCompaniesAll2Request](../../Models/Requests/HrisCompaniesAll2Request.md) | :heavy_check_mark:                                                            | The request object to use for the request.                                    |

### Response

**[HrisCompaniesAll2Response](../../Models/Requests/HrisCompaniesAll2Response.md)**
