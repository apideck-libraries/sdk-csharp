...
var res = await sdk.Webhook.Webhooks.CreateAsync(
    createWebhookRequest: new CreateWebhookRequest() {
        ...
        Status = Apideck.Unify.SDK.Models.Components.Status.Enabled,
        DeliveryUrl = "https://example.com/my/webhook/endpoint",
        Events = new List<WebhookEventType>() {
            Apideck.Unify.SDK.Models.Components.WebhookEventType.VaultConnectionCreated,
            Apideck.Unify.SDK.Models.Components.WebhookEventType.VaultConnectionUpdated,
        },
    },
    appId: "dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX"
);
